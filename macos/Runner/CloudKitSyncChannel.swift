...
class CloudKitSyncChannel: NSObject, FlutterStreamHandler {
  ...
  @discardableResult
  func handleRemoteNotification(_ userInfo: [String: Any]) -> Bool {
  ...
  @discardableResult
  static func handleRemoteNotification(_ userInfo: [String: Any]) -> Bool {
    guard let notification = CKNotification(fromRemoteNotificationDictionary: userInfo),
  ...
  private static var hasPushEntitlement: Bool {
    entitlementValues("com.apple.developer.aps-environment").isEmpty == false
  }
